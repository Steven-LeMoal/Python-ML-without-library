...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 14 13:15:17 2022
...
class Objet():
    ...
    def distance(self,autre):
        return (((self.x - autre.x)**2)+((self.y - autre.y)**2)+((self.z - autre.z)**2)+((self.t - autre.t)**2))**(1/2)
...
def Exo1():
    ...
    with open(r'/Users/steven/Documents/ESILV/IA & Data/TD3/IA3-ml_data_iris.txt','r') as f:
